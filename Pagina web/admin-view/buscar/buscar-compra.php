...
<html>
	<head>
		...
		<title>Buscar compra: admin</title>
		<?php 
	...
	<div id="contenido">
		<h3>Busqueda de compra por nombre de paciente</h3>
	
	    <form action="buscar-resultados.php" method="post">
			<input type="hidden" name="sender" value="comprar"/>
			<p>Nombre y apellido de paciente:
			<select name="runpaciente">
				<option>---</option>
				<?php 
					$consulta = pg_query("select * from paciente") or die('Consulta fallida');
