...
<html>
	<head>
		...
		<title>Buscar supervisor: admin</title>
		<?php 
	...
	<div id="contenido">
		<h3>Busqueda de supervisor por nombre y apellido</h3>
	
	    <form action="buscar-resultados.php" method="post">
			<input type="hidden" name="sender" value="supervisor"/>
			<p>Nombre y apellido supervisor: <select name="runsupervisor">
				<option>---</option>
				<?php 
					$consulta = pg_query("select run,nombre,apellido from supervisor") or die('Consulta fallida');
