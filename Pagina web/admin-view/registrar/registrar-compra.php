...
<html>
	...
	<div id="contenido">
		<h3>Para registrar una nueva compra, ingrese los datos del formulario a continuacion</h3>
	
	    <form action="registrar-submit.php" method="post">
			<input type="hidden" name="sender" value="compra"/>
			<p>Paciente: 
			...
			Nombre comercial medicamento comprado:
