...
<html>
	<head>
		...
		<title>Registrar especialidad: admin</title>
		<?php 
	...
	<div id="contenido">
		<h3>Para registrar una nueva especialidad, ingrese los datos del formulario a continuacion</h3>
	
	    <form action="registrar-submit.php" method="post">
			<input type="hidden" name="sender" value="especialidades"/>
			<p>Nombre de nueva especialidad: <input type="text" name="nombreespecialidad"></p>
