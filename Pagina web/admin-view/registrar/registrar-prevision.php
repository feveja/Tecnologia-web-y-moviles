...
<html>
	<head>
		...
		<title>Registrar prevision: admin</title>
		<?php 
	...
	<div id="contenido">
		<h3>Para registrar una nueva prevision, ingrese los datos del formulario a continuacion</h3>
	
	    <form action="registrar-submit.php" method="post">
			<input type="hidden" name="sender" value="prevision"/>
			<p>Nombre de prevision: <input type="text" name="nombreprevision"> Tipo de prevision: <input type="text" name="tipoprevision"></p>
