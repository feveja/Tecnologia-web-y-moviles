...
<html>
	<head>
		...
		<title>Editar prevision: admin</title>
	...
	<div id="contenido">
	    ...
	    <p>Nombre prevision:
				...
				<select name="atributo">
					<option>---</option>
				<?php 
					$consulta = pg_query("select column_name from information_schema.columns as tabla where tabla.table_name='prevision'
										except
										select column_name
										from information_schema.table_constraints as tc
										join information_schema.key_column_usage as ku on tc.constraint_name = ku.constraint_name
										and ku.table_name = 'prevision';") or die('Consulta fallida');
					while ($linea = pg_fetch_array($consulta)) {
