...
<html>
	<head>
		...
		<title>Editar paciente: admin</title>
	...
	<div id="contenido">
	    ...
	    <p>RUN Paciente:
				...
				<select name="atributo">
					<option>---</option>
				<?php 
					$consulta = pg_query("select column_name from information_schema.columns as tabla where tabla.table_name='paciente'
										except
										select column_name
										from information_schema.table_constraints as tc
										join information_schema.key_column_usage as ku on tc.constraint_name = ku.constraint_name
										and ku.table_name = 'paciente';") or die('Consulta fallida');
					while ($linea = pg_fetch_array($consulta)) {
