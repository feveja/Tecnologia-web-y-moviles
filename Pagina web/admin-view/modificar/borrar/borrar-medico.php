...
<html>
	<head>
		...
		<title>Borrar medico: admin</title>
	...
	<div id="contenido">
		<h3>Para borrar un medico, rellene los datos del formulario a continuacion</h3>
		...
		<input type="hidden" name="sender" value="medico"/>
			<p>RUN Medico:
				...
				<option>---</option>
				<?php 
					$consulta = pg_query("select * from mostrar_medicos()") or die('Consulta fallida');
