...
<html>
	<head>
		...
		<title>Borrar supervisor: admin</title>
	...
	<div id="contenido">
		<h3>Para borrar un supervisor, rellene los datos del formulario a continuacion</h3>
		...
		<input type="hidden" name="sender" value="supervisor"/>
			<p>RUN Supervisor:
				...
				<option>---</option>
				<?php 
					$consulta = pg_query("select run from mostrar_supervisor()") or die('Consulta fallida');
