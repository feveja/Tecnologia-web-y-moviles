...
<html>
	<head>
		...
		<title>Borrar medicamento: admin</title>
	...
	<div id="contenido">
		<h3>Para borrar un medicamento, rellene los datos del formulario a continuacion</h3>
		...
		<input type="hidden" name="sender" value="medicamento"/>
			<p>Nombre comercial:
				...
				<option>---</option>
				<?php 
					$consulta = pg_query("select * from mostrar_medicamentos()") or die('Consulta fallida');
