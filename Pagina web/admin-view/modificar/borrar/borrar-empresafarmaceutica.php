...
<html>
	<head>
		...
		<title>Borrar empresa farmaceutica: admin</title>
	...
	<div id="contenido">
		<h3>Para borrar una empresa farmaceutica, rellene los datos del formulario a continuacion</h3>
	
	    <form action="borrar-submit.php" method="post">
		<input type="hidden" name="sender" value="empresafarmaceutica"/>
			<p>Codigo de empresa farmaceutica:
				<select name="codigo">
				<option>---</option>
				<?php 
