...
<html>
	<head>
		...
		<?php
			...
			$consulta = pg_exec("select * from consulta2()") or die("Consulta fallida");
		?>
	...
	<div id="contenido">
		...
		<table>
			<tr>
				<th>RUN paciente</th><th>Nombre paciente</th><th>Apellido paciente</th><th>Nombre especialidad</th><th>Atenciones</th>
			</tr>
			<?php 
				while ($contenido = pg_fetch_assoc($consulta)){
					echo "<tr> 
						...
						<td>".ucfirst($contenido['apellido_paciente'])."</td>
						<td>".ucfirst($contenido['nombre_especialidad'])."</td>
						<td>".$contenido['atenciones']."</td>
						</tr>";
				}
			?>
		</table>
