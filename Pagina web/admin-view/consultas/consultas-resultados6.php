...
<html>
	<head>
		...
		<?php
			...
			$consulta = pg_exec("select * from vista1()") or die("Consulta fallida");
		?>
	...
	<div id="contenido">
		...
		<table>
			<tr>
				<th>RUN</th><th>Nombre</th><th>Apellido</th><th>Fecha de nacimiento</th><th>A&ntilde;os ejerciendo</th><th>Imagen</th>
			</tr>
			<?php 
