...
<html>
	<head>
		...
		<?php
			...
			$consulta = pg_exec("select * from vista2()") or die("Consulta fallida");
		?>
	...
	<div id="contenido">
		...
		<table>
			<tr>
				<th>RUN medico</th><th>A&ntilde;o de recetas</th><th>Total de recetas emitidas</th>
			</tr>
			<?php 
				while ($contenido = pg_fetch_assoc($consulta)){
					echo "<tr> 
						<td>".$contenido['run_medico']."</td>
						<td>".$contenido['anio_recetas']."</td>
