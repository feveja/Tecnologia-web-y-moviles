...
<html>
	<head>
		...
		<?php
			...
			$consulta = pg_exec("select * from vista3()") or die("Consulta fallida");
		?>
	...
	<div id="contenido">
		<h3>Resultados vista</h3>
		<table>
			<tr>
				<th>Nombre del paciente</th><th>Nombre del medico</th><th>Fecha</th><th>Cantidad de recetas</th>
			</tr>
			<?php 
