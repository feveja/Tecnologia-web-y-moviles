...
<html>
	<head>
		...
		<?php
			...
			$consulta = pg_exec("select * from consulta3()") or die("Consulta fallida");
		?>
	...
	<div id="contenido">
		...
		<table>
			<tr>
				<th>Codigo farmacia</th><th>Nombre farmacia</th><th>Direccion farmacia</th><th>Telefono farmacia</th>
			</tr>
			<?php 
				while ($contenido = pg_fetch_assoc($consulta)){
					echo "<tr> 
						<td>".$contenido['codigo_farmacia']."</td>
						<td>".ucfirst($contenido['nombre_farmacia'])."</td>
						<td>".ucwords($contenido['direccion_farmacia'])."</td>
						<td>".$contenido['telefono_farmacia']."</td>
						</tr>";
				}
			?>
		</table>
