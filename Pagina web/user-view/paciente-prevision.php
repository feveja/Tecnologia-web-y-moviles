...
<html>
	...
	<div id="contenido">	
		<h3>Prevision asociada al run: <?php echo $usuario_actual?></h3>
		<table>
			<tr>
				<th>
					Nombre
			...
			<?php
				$consulta = pg_exec("select bp.nombreprevision, pre.tipo from buscar_paciente('".$usuario_actual."') as bp, prevision as pre where bp.nombreprevision=pre.nombre;");
