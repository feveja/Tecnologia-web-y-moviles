...
<html>
	...
	<div id="contenido">	
		<h3>Recetas asociadas al run: <?php echo $usuario_actual?></h3>
        <table>
				<tr>
					<th>
						Codigo
				...
				<?php 
				$consulta = pg_exec("select * from mostrar_receta() where runpaciente='".$usuario_actual."'") or die("Consulta fallida");
