...
<html>
	...
	<div id="contenido">	
		<h3>Compras realizadas por el paciente: <?php echo $usuario_actual?></h3>
        <table>
            <tr>
                <th>
                    RUN Paciente
            ...
            <?php
				$consulta = pg_exec("select * from buscar_comprar('".$usuario_actual."')");
